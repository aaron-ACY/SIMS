...
public interface IUserService
{
    ...
    /// </summary>
    Task<UserProfileResponse> CreateAsync(CreateUserRequest request);

    /// <summary>
    /// Updates the caller's own first name, last name and email.
    /// Requires the EDIT_INFO permission.
    /// </summary>
    Task<UserProfileResponse> UpdateMyInfoAsync(int userId, UpdateMyInfoRequest request);
